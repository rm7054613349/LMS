...
class AuthhWithBiomerticsScreen extends StatefulWidget {
  AuthhWithBiomerticsScreen({Key? key}) : super(key: key);
  ...
  @override
  State<AuthhWithBiomerticsScreen> createState() => _AuthhWithBiomerticsScreenState();
}

class _AuthhWithBiomerticsScreenState extends State<AuthhWithBiomerticsScreen> {
  ...
  void checkBiometricsEnabled() async {
    bool biometricsEnabled = await Pref.readBool('biometricsEnabled');
  ...
  Future<void> _showBiometricsDialog() async {
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Text(
                  'Would you like to set up biometrics for easy login ?',
                  style: TextStyle(color: AppTheme.textColorLight),
                ),
              ],
            ),
  ...
  Future<void> _authenticateWithBiometrics() async {
    ...
    if (authenticated) {
      Pref.writeBool('biometricsEnabled', true);
      Get.offNamed('/dashboard');
    } else {
      Pref.writeBool('biometricsEnabled', false);
      Get.offNamed('/dashboard');
    }
  }
  ...
  Widget build(BuildContext context) {
    //return _showBiometrics? biometrics():
    return WillPopScope(
